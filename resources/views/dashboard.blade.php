...
@section('content')
    <section id="content">
        <section class="main padder">
            <div class="row">
                <div class="col-lg-12">
                    <section class="toolbar clearfix m-t-large m-b"> <a href="mail.html" class="btn btn-white btn-circle"><i class="fa fa-envelope-o"></i>Inbox <b class="badge bg-white">5</b></a> <a href="index.html#" class="btn btn-primary btn-circle active"><i class="fa fa-lightbulb-o"></i>Projects</a> <a href="index.html#" class="btn btn-success btn-circle"><i class="fa fa-check"></i>Tasks</a> <a href="index.html#" class="btn btn-info btn-circle active"><i class="fa fa-clock-o"></i>Timeline<b class="badge bg-info"><i class="fa fa-plus"></i></b></a> <a href="index.html#" class="btn btn-inverse btn-circle"><i class="fa fa-bar-chart-o"></i>Stats</a> <a href="calendar.html" class="btn btn-warning btn-circle"><i class="fa fa-calendar-o"></i>Calendar</a> <a href="index.html#" class="btn btn-danger btn-circle"><i class="fa fa-group"></i>Groups</a> <a href="index.html#" class="btn btn-circle"><i class="fa fa-plus"></i>More</a> </section>
                </div>
                <div class="col-lg-6">
                    <div class="row">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            <ul class="nav nav-pills pull-right">
                                <li><a href="index.html#" data-loading-text="loading..."><i class="fa fa-retweet"></i></a></li>
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="index.html#"> <span class="text">Day</span> <span class="caret"></span> </a>
                                    <ul class="dropdown-menu pull-right">
                                        <li class="active"><a href="index.html#">Day</a></li>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            <ul class="nav nav-pills pull-right">
                                <li> <a href="index.html#" class="panel-toggle text-muted"><i class="fa fa-caret-down fa-lg text-active"></i><i class="fa fa-caret-up fa-lg text"></i></a> </li>
                            </ul>
                        ...
                        <section style="height:210px" class="panel-body scrollbar scroll-y m-b">
                            <article class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <a href="index.html#" class="h4">Bootstrap 3.0 is comming</a> <small class="block"><a href="index.html#" class="">John Smith</a> <span class="label label-success">Circle</span></small> <small class="block">Sleek, intuitive, and powerful mobile-first front-end framework for faster and easier web development.</small>
                                </div>
                            </article>
                            ...
                            <article class="media">
                                <div class="media-body">
                                    ...
                                    <a href="index.html#" class="h4 text-success">Mobile first html/css framework</a> <small class="block">Bootstrap, Ratchet</small>
                                </div>
                            </article>
                        </section>
                    </section>
                        ...
                        <ul class="list-group">
                            <li class="list-group-item" data-toggle="class:active" data-target="#todo-1">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div><a href="index.html#" class="h5">Coding on app</a></div>
                            ...
                            <li class="list-group-item bg" data-toggle="class:active" data-target="#todo-2">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div><a href="index.html#" class="h5">Reply email</a></div>
                            ...
                            <li class="list-group-item" data-toggle="class:active" data-target="#todo-3">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div><a href="index.html#" class="h5">Coffee time</a></div>
                            ...
                            <li class="list-group-item bg" data-toggle="class:active" data-target="#todo-4">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div><a href="index.html#" class="h5">Listen music</a></div>
                    ...
                    <section class="comment-list block">
                        <article id="comment-id-1" class="comment-item media arrow arrow-left">
                            ...
                            <section class="media-body panel">
                                <header class="panel-heading clearfix"> <a href="index.html#">John smith</a> <label class="label bg-info m-l-mini">Editor</label> <span class="text-muted m-l-small pull-right"><i class="fa fa-clock-o"></i> 24 minutes ago</span> </header>
                                <div class="panel-body">
                                    ...
                                    <div class="comment-action m-t-small"> <a href="index.html#" data-toggle="class" class="btn btn-white btn-xs active"> <i class="fa fa-star-o text-muted text"></i><i class="fa fa-star text-danger text-active"></i> Like </a> <a href="index.html#comment-form" class="btn btn-white btn-xs"><i class="fa fa-mail-reply text-muted"></i> Reply</a> </div>
                                </div>
                            </section>
                        </article>
                        ...
                        <article id="comment-id-2" class="comment-item comment-reply media arrow arrow-left">
                            ...
                            <section class="media-body panel text-small">
                                <div class="panel-body"> <a href="index.html#">Mika Sam</a> <label class="label bg-inverse m-l-mini">Admin</label> Report this comment is helpful <span class="text-muted m-l-small pull-right"><i class="fa fa-clock-o"></i> 10 minutes ago</span> </div>
                            </section>
                        </article>
                        ...
                        <article id="comment-id-3" class="comment-item media arrow arrow-left">
                            <a class="pull-left thumb-small avatar"><img src="images/avatar.jpg" class="img-circle"></a>
                            <section class="media-body panel">
                                <header class="panel-heading clearfix"> <a href="index.html#">By me</a> <label class="label bg-default m-l-mini">User</label> <span class="text-muted m-l-small pull-right"> <i class="fa fa-clock-o"></i> about 1 hour ago </span> </header>
                                <div class="panel-body">
                                    <div>This comment was posted by you.</div>
                                    <div class="comment-action m-t-small"> <a href="index.html#comment-id-3" data-dismiss="alert" class="btn btn-white btn-xs"> <i class="fa fa-trash-o text-muted"></i> Remove </a> </div>
                                </div>
                            </section>
                        </article>
                        <article id="comment-id-4" class="comment-item media arrow arrow-left">
                            <a class="pull-left thumb-small avatar"><img src="images/avatar.jpg" class="img-circle"></a>
                            <section class="media-body panel">
                                <header class="panel-heading clearfix"> <a href="index.html#">Peter</a> <label class="label bg-primary m-l-mini">Vip</label> <span class="text-muted m-l-small pull-right"><i class="fa fa-clock-o"></i> 2 hours ago</span> </header>
                                <div class="panel-body">
                                    <blockquote>
                                    ...
                                    <div class="comment-action m-t-small"> <a href="index.html#" data-toggle="class" class="btn btn-white btn-xs"> <i class="fa fa-star-o text-muted text"></i> <i class="fa fa-star text-danger text-active"></i> Like </a> <a href="index.html#comment-form" class="btn btn-white btn-xs"> <i class="fa fa-mail-reply text-muted"></i> Reply </a> </div>
                                </div>
                            </section>
                        </article>
